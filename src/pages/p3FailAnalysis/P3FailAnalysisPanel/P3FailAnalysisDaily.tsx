...
import P3Table from './table/AccountActivityTable'
...
import { p3FailAnalysisDataSelector } from '../../../store/failAnalysis/p3-fail-analysis'
import { useSelector, useDispatch } from 'react-redux'
import {
  getComments,
  commentSelector,
} from '../../../store/failAnalysis/p3-fail-analysis-user'

const P3FailAnalysisDaily = () => {
  ...
  const savedComments = async (tb: any) => {
    ...
    const userData = await dispatch(
      getComments(type.value, data.p3Report[tb.cell.row.id].failUniqueId)
    )
        ...
        >
          <Button
            ...
            onClick={() => {
              ...
              newUserComment(
                type.value,
                data.p3Report[tb.cell.row.id].failUniqueId,
  ...
  return (
    <>
      <RootContainer>
        <StyledPanelHead>
          <StyledPanelHeadTitle>P3 FAIL ANALYSIS</StyledPanelHeadTitle>
        </StyledPanelHead>
        <StyledPanelSelect>
          <StyledSelectWrapper>
            <div className="wd230">
          ...
          {action === 'search' && type.value === 'daily' && (
            <CardContainer style={{ width: '50%' }}>
              ...
              <div style={{ width: '100%' }}>
                <StyledTableContainer>
                  <P3Table
                    data={data && data.p3Summary ? data.p3Summary : []}
                    columns={[
                      {
          ...
          {data.p3Report && action === 'search' && (
            <StyledTableContainer>
              <P3Table data={data.p3Report} columns={TableColumnsDaily} />
            </StyledTableContainer>
          )}
        </StyledPanelSelect>
      </RootContainer>
...
export default P3FailAnalysisDaily
