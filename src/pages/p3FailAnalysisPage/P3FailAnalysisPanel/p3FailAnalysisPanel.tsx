  ...
  const savedComments = async (tb: any) => {
    ...
    await dispatch(
      getSelectedRow(
        ...
        input.endDate,
        ageRange.value,
        data.p3Report[tb.cell.row.id].accountNumber.toString(),
        input.branch,
        data.p3Report[tb.cell.row.id].entity.toString(),
        buySell.value,
        data.p3Report[tb.cell.row.id].cusip.trim()
      )
    )
    ...
    <>
      <RootContainer>
        ...
        <StyledPanelSelect>
          ...
          {data.p3Report && action === 'search' && loading && (
            <RootContainer>
              <StyledTableContainer>
                <P3Table
                  data={data.p3Report}
...
export default P3FailAnalysisPanel
